...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [LAYER_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(LAYER_FN),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [LAYER_ALT] = LAYOUT(
        _______, _______, _______, _______, MT(MOD_MASK_ALT,KC_F4), _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        MT(MOD_MASK_ALT,KC_TAB), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
